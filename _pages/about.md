---
permalink: /
title: "Hello! I'm Shuang LIANG（梁爽）."
excerpt: "About me"
author_profile: true
redirect_from: 
  - /about/
...
I'm currently an undergraduate student at <a href = "https://physics.whu.edu.cn">School of Physics and Technology, Wuhan University</a>. My research interests fall into the field of Electrical Engineering, particularly in the field of **optoelectronic semiconductor devices**, **Photonics** and **AI for science**. I'm looking for MS/Ph.D. positions in these fields, please don't hesitate to contact me if you're interested.
...
<b style="font-size: 1em;">
    &nbsp;
    [<a href="/files/Shuang Liang_Resume.pdf">PDF</a>]
</b>
...
<table style="width:100%;border:0px;border-spacing:0px;border-collapse:separate;margin-right:0;margin-left:0;font-size:0.95em;">
  ...
  <tr>
    <td style="padding:8px;width:30%;vertical-align:middle;border:none;">
      <img src='images/CASSemiconductor.png' width="300">
    </td>
    <td style="padding:20px;width:70%;vertical-align:middle;border-right:none;border:none;">
      <b><a href="https://www.semi.ac.cn">Institute of Semicondutors</a>, CAS.</b>
      <br>
      Huangkun Class, joint training program of WHU & Institute of Semiconductors, CAS
      <br>
      (Mar. 2022 - Now)
    </td>
  </tr>
    <tr>
    <td style="padding:8px;width:30%;vertical-align:middle;border:none;">
      <center><img src='images/zz7z.png' width="200"></center>
    </td>
    <td style="padding:20px;width:70%;vertical-align:middle;border-right:none;border:none;">
...
<table style="border:none;font-size:0.95em;">
  <tr>
    <td style="border:none;"><i>First Class Scholarship</i> (10/180, ¥3,000 CNY) by Wuhan University.
    </td>
...
* I once enrolled at UESTC & UoG joint training program as a B.Eng student major in EE for three months, and I quit because the curriculum didn't contain Quantum Mechanics and Mathematical Analysis (I was convinced that a solid mathematical and physical foundation is vital for a EE student.). But now I'm heading back to the field of EE : ).
